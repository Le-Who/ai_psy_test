...
export const app = {
	...
	handleQuizAnswer(idx, btn) {
		...
		// ⚡ Bolt: Cached querySelectorAll result to avoid redundant full-document traversals in event handler
		const allBtns =
			this.ui && this.ui.quizContainer
				? this.ui.quizContainer.querySelectorAll(".quiz-opt")
