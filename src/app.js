...
export const app = {
	...
	handleQuizAnswer(idx, btn) {
		...
		// ⚡ Bolt: Cache NodeList and scope query to UI container to avoid redundant full-document traversals
		const allBtns = (this.ui.quizContainer || document).querySelectorAll(
			".quiz-opt",
		);
