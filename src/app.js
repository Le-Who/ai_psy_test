...
export const app = {
	...
	renderQ() {
		...
		if (isQuizMode) {
			...
			if (quizDiv) {
				...
				// OPTIMIZATION: Use DocumentFragment and textContent to avoid innerHTML parsing and regex escaping in hot loop
	...
	handleQuizAnswer(idx, btn) {
		...
		// OPTIMIZATION: Cache querySelectorAll to avoid redundant DOM traversal
