...
export const app = {
	...
	handleQuizAnswer(idx, btn) {
		...
		// ⚡ Bolt: Cache NodeList and scope query to container to avoid redundant full-document traversals in hot handler
		const container = (this.ui && this.ui.quizContainer) || document;
