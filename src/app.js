...
export const app = {
	...
	renderQ() {
		...
		if (isQuizMode) {
			...
			if (quizDiv) {
				...
				// OPTIMIZATION: Use DocumentFragment and textContent to avoid innerHTML parsing and layout thrashing
	...
	handleQuizAnswer(idx, btn) {
		...
		// OPTIMIZATION: Cache querySelectorAll to avoid redundant DOM traversals
