...
export const app = {
	...
	handleQuizAnswer(idx, btn) {
		...
		// ⚡ Bolt: Scope DOM query to cached container and reuse NodeList to avoid redundant document-wide searches
		const root = (this && this.ui && this.ui.quizContainer) || document;
		const allBtns = root.querySelectorAll(".quiz-opt");
