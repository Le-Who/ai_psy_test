...
export const Utils = {
	...
	escapeHtml: (unsafe) => {
		...
		// ⚡ Bolt: Fast-path return for strings without HTML entities to avoid regex replace overhead
		if (!HTML_CHECK_REGEX.test(unsafe)) return unsafe;
