...
describe("Utils", () => {
	describe("escapeHtml", () => {
		...
		it("should enforce string coercion for arrays to prevent XSS array bypass", () => {
			const arrayBypass = ['<script>alert("XSS")</script>'];
			const safe = Utils.escapeHtml(arrayBypass);
