...
## 2024-05-24 - [Form Accessibility: Label For Attribute]
**Learning:** The form labels lacked `for` attributes linked to the `id` of the respective input elements. This is an accessibility issue because screen readers and click-to-focus behavior depend on it.
**Action:** Always ensure `<label>` tags have a `for` attribute matching the `id` of their input.
