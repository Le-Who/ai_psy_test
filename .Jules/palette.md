...
## 2025-02-12 - [Accessible Form Labels]
**Learning:** Adding explicit `for` attributes to `<label>` elements matching their corresponding inputs is critical for screen readers and allows users to click the label text to focus the field.
**Action:** Always map `<label for="...">` to the `<input id="...">` in all new forms.
