...
ОГРАНИЧЕНИЕ НА КОЛИЧЕСТВО OUTCOMES В ВОПРОСЕ:
- **Обычно 1 outcome на вопрос.**
- **Максимум 2 outcomes на один вопрос.**
- Вопросы, влияющие сразу на 2 outcomes, должны действительно измерять их пересечение.
- **Строго запрещено** давать вопросу 3 и более outcomes в mapping.

BALANCE & REVERSE ITEMS:
- Для каждого outcome должны существовать прямые и обратные (reverse) вопросы.
- Не "кормить" все outcomes одинаково — вопросы должны быть дискриминативными.

ЭТИ ПРАВИЛА ОБЯЗАТЕЛЬНЫ ДЛЯ КАЖДОГО ВОПРОСА.`,
